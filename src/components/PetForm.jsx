  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errorData.message || "Failed to add pet listing.");
      }

      setMessage({
        type: "success",
        text: "Pet listed successfully! Redirecting...",
      });
      ...
      >
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full px-3.5 py-2 text-sm bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-xl focus:outline-none focus:border-emerald-500 transition-colors"
            placeholder="https://imgbb.com/your-hosted-image-link"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-3.5 py-2 text-sm bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-xl focus:outline-none focus:border-emerald-500 transition-colors"
              placeholder="e.g. Excellent health"
            />
          </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            placeholder="Share information about the pet's personality, habits, and history..."
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full sm:w-auto self-end px-6 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-semibold text-sm rounded-xl shadow-md hover:opacity-95 disabled:opacity-50 transition-all select-none focus:outline-none"
        >
